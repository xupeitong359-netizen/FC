    ...
    <motion.div
     ...
     style={{
      boxShadow: isOccupiedTerritory
       ? '0 20px 40px -4px rgba(225, 29, 72, 0.15), 0 0 0 1px rgba(244, 63, 94, 0.2)'
       : '0 20px 40px -4px rgba(0, 0, 0, 0.12), 0 0 0 1px rgba(0, 0, 0, 0.04)',
     }}
    >
     {/* Top Accent Bar */}
     <div
       ...
       <div className="flex items-center gap-1.5 flex-wrap">
        {activeDeposits.length > 0 ? (
         activeDeposits.map((item) => (
          <div
           key={item.key}
           className="flex items-center gap-1 px-1.5 py-0.5 rounded bg-white border border-slate-200 font-mono text-[11px] shadow-2xs"

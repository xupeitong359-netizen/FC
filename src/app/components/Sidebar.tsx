...
import { Globe, Map, Flag, Settings, ShieldAlert, Swords, Compass, MessageSquare } from 'lucide-react';
...
export function Sidebar({ activeTab, setActiveTab }: SidebarProps) {
  ...
  const navItems = [
    { id: 'lobby', label: '全球粉陆', icon: Globe },
    { id: 'messages', label: '消息中心', icon: MessageSquare },
    { id: 'world_map', label: '世界地图', icon: Map, hotkey: 'F1' },

   ...
   <div className="p-3 sm:p-4 flex-1 flex flex-col justify-between">
    <div>
     ...
     <div className="flex items-center gap-1.5 text-[11px] sm:text-xs text-slate-700 mb-3">
      <span className="text-[9px] px-1 py-0.2 rounded bg-indigo-50 text-indigo-700 border border-indigo-100/80 font-semibold shrink-0">
       创作者
      </span>
      <span className="font-medium truncate text-slate-800">{douyinNickname}</span>
     </div>
    ...
    <div className="pt-1.5 border-t border-slate-100 mt-1 space-y-1">
     ...
     <div className="grid grid-cols-2 gap-1 w-full" onClick={(e) => e.stopPropagation()}>
      ...
      >
       ...
       <span className="shrink-0">大陆档案</span>

...
authRouter.post('/register', async (req, res) => {
  try {
    const { username, password, douyinName, isLingyuBaby, creatorId, adminPassword, avatarColor: customAvatarColor, avatarUrl, avatarEmoji } = req.body;
    ...
    const isCreatorStatus = Boolean(cleanCreatorId) || Boolean(isLingyuBaby) || cleanUsername.toLowerCase() === 'admin';
